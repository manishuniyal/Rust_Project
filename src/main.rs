...
use std::io;
#[path = "modules_packages/module1.rs"] mod module1;
#[path = "modules_packages/fun_test.rs"] mod fun_test;
#[path = "modules_packages/array_and_vector.rs"] mod array_and_vector;
#[path = "modules_packages/fun_test2.rs"] mod fun_test2;

#[path = "modules_packages/input_and_output.rs"] mod input_and_output;

#[path = "modules_packages/module2.rs"] mod module2;
